...
public class _Generator {
	...
	public static DataSource getDataSource() {
		DruidPlugin druidPlugin = PlayConfig.getDruidPlugin();
		druidPlugin.start();
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.cser.play.common.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/newbula/play/common/model/base";

		System.out.println("输出路径：" + baseModelOutputDir);

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.cser.play.common.model";
